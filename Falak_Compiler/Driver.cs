    ...
    public class Driver
    {
        ...
        void Run(string[] args)
        {
            ...
            try
            {
                ...
                var code_generator = new WatVisitor(semantic.LocalSymbolTable, semantic.GlobalVariableTable, semantic.GlobalFunctionTable);
                var outputPath = Path.ChangeExtension(inputPath, ".wat");
                File.WriteAllText(
                    outputPath,
                    code_generator.Visit((dynamic)program));
                Console.WriteLine(
